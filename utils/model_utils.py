...
def get_model(cfg: DictConfig, pretrained_net=None):
    ...
    if cfg.model.name == 'covae':
        return CoVAE(**cm_kwargs,
                     ...
                     ua_lmc_umin=cfg.model.get('ua_lmc_umin', 0.5),
                     ua_lmc_umax=cfg.model.get('ua_lmc_umax', 2.),
                     ua_lmc_eps=cfg.model.get('ua_lmc_eps', 1e-6),
                     ua_lmc_warmup_frac=cfg.model.get('ua_lmc_warmup_frac', 0.1),
